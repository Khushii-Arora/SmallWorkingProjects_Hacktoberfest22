#ifndef COLORS_DOT_HPP
#define COLORS_DOT_HPP
...
#error                                                                         \
  "Please include colors.hpp before any windows system headers or set _WIN32_WINNT at least to _WIN32_WINNT_VISTA"
